            ...
            <div className="mb-4 sm:mb-6 max-w-md mx-auto">
              ...
              <div className="relative">
                <Select onValueChange={handleCityChange} defaultValue={city}>
                  <SelectTrigger id="city-select" className="w-full bg-white border-2 border-blue-300 rounded-lg py-2 pl-3  text-left cursor-default focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 sm:text-sm">
